...
const projects = [
  ...
  },
  {
    ...
    description:
      "We build a supportive network of parents, coaches, and volunteers committed to long-term empowerment.",
    icon: Users,
    image: "/IMG-20250810-WA0027.jpg",
